        ...
        <div className="events-carousel">
          <button className="event-card" onClick={() => handleEventClick(101)}>
            <div className="event-poster-container">
              <img src={eventPlaceholder} alt="Event Poster" className="event-poster" style={{ objectFit: 'cover' }} /> {/* Added inline style for objectFit */}
            </div>
            <div className="event-info">
              <p className="provider-date">provider<br />Date & time</p>
          ...
          <button className="event-card" onClick={() => handleEventClick(102)}>
            <div className="event-poster-container">
              <img src={eventPlaceholder2} alt="Event Poster" className="event-poster" style={{ objectFit: 'cover' }} /> {/* Added inline style for objectFit */}
            </div>
            <div className="event-info">
              <p className="provider-date">provider<br />Date & time</p>
              <button className="edit-button">
